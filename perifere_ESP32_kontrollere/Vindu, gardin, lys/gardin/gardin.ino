...
// lastes opp til hver enkelt ESP32 som styrer en gardin. CoT nækkelen må skiftes.
...
char key[] = "6488"; // Nøkkel-informasjon om konsollet for styring av gardinen
...
void loop() {
  ...
  if(pos == 0 || pos == 180){ // dersom gardinen ikke beveger seg
    ...
    curtainState = static_cast<int>(static_cast<String>(CoT_signal)[3] - 48); // leser fra CoT om gardinen er lukket "0" eller åpen "1"
